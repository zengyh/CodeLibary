...
public class IntegerSortDescMap<K, V extends Integer> extends TreeMap<K, V>
{
    ...
    public IntegerSortDescMap() {
    }

    public IntegerSortDescMap(SortedMap<K, ? extends V> m) {
        if (m != null) {
    ...
    public IntegerSortDescMap(Map<? extends K, ? extends V> m) {
        if (m != null) {
