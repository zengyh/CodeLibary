...
/**
 * 文件名称: FloatSortAscMap.java
 * 编写人: yh.zeng
 * 编写时间: 14-12-1 下午3:42
 * 文件描述: 按照value升序排序
 */
public class FloatSortAscMap<K, V extends Float> extends TreeMap<K, V>
{
    ...
    public FloatSortAscMap() {
    }

    public FloatSortAscMap(SortedMap<K, ? extends V> m) {
        if (m != null) {
    ...
    public FloatSortAscMap(Map<? extends K, ? extends V> m) {
        if (m != null) {
