...
/**
 * 文件名称: DoubleSortDescMap.java
 * 编写人: yh.zeng
 * 编写时间: 14-12-1 下午3:42
 * 文件描述: 按照value降序排序
 */
public class DoubleSortDescMap<K, V extends Double> extends TreeMap<K, V>
{
    ...
    public DoubleSortDescMap() {
    }

    public DoubleSortDescMap(SortedMap<K, ? extends V> m) {
        if (m != null) {
    ...
    public DoubleSortDescMap(Map<? extends K, ? extends V> m) {
        if (m != null) {
